...
def PushForward_Func(K, E, T, Design_Blocks, Moments_Fit, Moments_Spline, Spline_der_bool):
	...
	for i in range(NumOfJumps):
		...
		Predicts.append(Sol.y[:,-1])

	return Residuals.flatten(), np.array(Predicts)