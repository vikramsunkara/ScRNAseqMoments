...
datapath = "/nfs/datanumerik/people/araharin/Unpacked_MRNA_data_10000/txt_start30/"

path_kernels = ["Double_Up_data_", "No_Up_data_", "Single_Up_data_"] # Do not change the order of the data
...
df = DataFrame(Double_Up = collect_MI_kernels[1], No_Up = collect_MI_kernels[2], Single_Up = collect_MI_kernels[3], 
		Num_D = collect_edges_num[1], Num_N = collect_edges_num[2], Num_S = collect_edges_num[3])
CSV.write("MI_10000traj_shift30.csv", df)
